...
//  WeatherApp
//
//  Created by Kondal Palugudi on 07/01/2017.
//  Copyright © 2017 Palugudi. All rights reserved.
//
...
class ViewController: UIViewController, UISearchBarDelegate {
    ...
    func searchBarSearchButtonClicked(_ searchBar: UISearchBar) {
        ...
        let urlRequest = URLRequest(url: URL(string: "http://api.apixu.com/v1/current.json?key=bc2a6c957e05621c85f2bf6633330728&q=\(searchBar.text!.replacingOccurrences(of: " ", with: "%20"))")!)
